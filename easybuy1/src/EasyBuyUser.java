...
public class EasyBuyUser  implements java.io.Serializable {
    ...
    /** full constructor */
    public EasyBuyUser(String euUserName, String euPassword, Integer euSex, Date euBirthday, String euIdentityCode, String euEmail, String euMobile, String euAddress, Integer euStatus, Set easyBuyComments, Set easyBuyOrders, Set easyBuyShoppingCarts) {
        this.euUserName = euUserName;
        this.euPassword = euPassword;
        this.euSex = euSex;
