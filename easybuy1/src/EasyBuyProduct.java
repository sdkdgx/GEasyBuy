...
public class EasyBuyProduct  implements java.io.Serializable {
	...
	/** minimal constructor */
    public EasyBuyProduct(EasyBuyProductCategory easyBuyProductCategory, String epName, String epDescription, Double epPrice, Integer epStock, Integer epcChildId, String epFileName, Integer epSpecial) {
    ...
    /** full constructor */
    public EasyBuyProduct(EasyBuyProductCategory easyBuyProductCategory, String epName, String epDescription, Double epPrice, Integer epStock, Integer epcChildId, String epFileName, Integer epSpecial, Set easyBuyOrderDetails, Set easyBuyShoppingCarts) {
        this.easyBuyProductCategory = easyBuyProductCategory;
        this.epName = epName;
        this.epDescription = epDescription;
        this.epPrice = epPrice;
    ...
    public void setEasyBuyProductCategory(EasyBuyProductCategory easyBuyProductCategory) {
        this.easyBuyProductCategory = easyBuyProductCategory;
    }
