...
public class EasyBuyOrder  implements java.io.Serializable {
	...
	/** minimal constructor */
    public EasyBuyOrder(EasyBuyUser easyBuyUser, Timestamp eoCreateTime, Integer eoStatus, Integer eoType, String eoRerAddress) {
    ...
    /** full constructor */
    public EasyBuyOrder(EasyBuyUser easyBuyUser, Timestamp eoCreateTime, Integer eoStatus, Integer eoType, String eoRerAddress, Set easyBuyOrderDetails) {
        this.easyBuyUser = easyBuyUser;
        this.eoCreateTime = eoCreateTime;
        this.eoStatus = eoStatus;
        this.eoType = eoType;
