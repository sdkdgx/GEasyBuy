...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="news.jsp">æ°é»</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
	...
	<div class="main">
		...
		<div class="manage">
			<form action="manage-result.jsp">
				<table class="form">
					<tr>
						<td class="field">æ°é»æ é¢ï¼</td>
						<td><input type="text" class="text" name="title" value="" /></td>
					</tr>
					<tr>
						<td class="field">æ°é»åå®¹ï¼</td>
						<td><textarea name="content"></textarea></td>
					</tr>
					<tr>
						<td></td>
						<td><label class="ui-blue"><input type="submit" name="submit" value="æ·»å " /></label></td>
					</tr>
				</table>
			</form>
		</div>
