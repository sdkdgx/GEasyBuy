...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加分类</h2>
		<div class="manage">
			<form action="/easybuy/productCategory/productCategoryCreate">
				<table class="form">
					<tr>
						<td class="field">父分类：</td>
						<td>
							<select name="epcParentId">
								<c:forEach var="ebpc" items="${ebpcs }" varStatus="item">
					...
					<tr>
						...
						<td><input type="text" class="text" name="epcName" value="分类名称" /></td>
					</tr>
					<tr>
						<td></td>
