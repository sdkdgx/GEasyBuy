...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="/easybuy/user/doRegister" onsubmit="return checkForm(this);">
				<table>
					<tr>
					...
					<tr>
						...
						<td>
<!-- 							<input class="text" type="password" name="euMobile" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span> -->
							<select name="euSex">
